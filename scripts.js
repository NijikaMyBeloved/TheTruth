function runAnimations() {
  ...
  function func_1413_1429() {
    ...
    document.querySelector("#id-1439").classList.add("nullAnimation-1439");
    ...
    document
      .querySelector(".truth-untold-1-3068-0")
    ...
    document
      .querySelector(".europa-the-last-1-4047-0")
    ...
    document
      .querySelector(".europa-the-last-1-2040-0")
    ...
    setTimeout(() => {
      document
        ...
        .addEventListener("click", func_1418_1429);
    }, 100);
  }

  function func_1418_1429() {
    ...
    document.querySelector("#id-1447").classList.add("nullAnimation-1447");
    document.querySelector("#id-1413").classList.add("animationClass-1433");
    document.querySelector("#id-1427").classList.add("nullAnimation-1427");
    document.querySelector("#id-1428").classList.add("nullAnimation-1428");
    document
      .querySelector(".truth-untold-1-3068-0")
      .classList.add("animationClass-1432-1432-0");
    document.querySelector("#id-146").classList.add("animationClass-1432");
    document.querySelector("#id-1417").classList.add("nullAnimation-1417");
    document
      .querySelector(".europa-the-last-1-4047-0")
    ...
    document
      .querySelector("#id-1418")
      .removeEventListener("click", func_1418_1429);

    setTimeout(() => {
      //loop login
      document.querySelector("#id-142").classList.remove("animationClass-142");
      document.querySelector("#id-1439").classList.remove("nullAnimation-1439");
      ...
      document.querySelector("#id-1447").classList.remove("nullAnimation-1447");
      document
        .querySelector("#id-1413")
        .classList.remove("animationClass-1433");
      document.querySelector("#id-1427").classList.remove("nullAnimation-1427");
      document.querySelector("#id-1428").classList.remove("nullAnimation-1428");
      document
        .querySelector(".truth-untold-1-3068-0")
        .classList.remove("animationClass-1432-1432-0");
      document.querySelector("#id-146").classList.remove("animationClass-1432");
      document.querySelector("#id-1417").classList.remove("nullAnimation-1417");
      document
        .querySelector(".europa-the-last-1-4047-0")
